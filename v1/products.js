...
(() => {
  ...
  // v6 — пересобранные позиции: торты и десерты выровнены по габариту и линии
  // основания, осетинские пироги перенесены в общую сцену.
  const V6_IDS = new Set(["777", "749", "747", "748", "751",
                          "756", "757", "758", "778",
                          "764", "765", "766", "768", "769",
                          "760", "761", "781", "782",
                          "742", "743", "744", "745", "746", "780",
                          "736", "737", "738", "739", "741",
                          "772", "773", "774", "775", "776",
                          "801", "802", "803"]);
  const V7_IDS = new Set(["736", "737", "738", "739", "741", "772", "773", "774", "775", "776", "801", "802", "803"]);
  ...
  const product = (id, category, name, price, unit, badge = "") => ({
    ...
    badge,
    article: `20${id}`,
    image: `/v1/assets/products/${category}-${id}-v${V7_IDS.has(String(id)) ? 7 : V6_IDS.has(String(id)) ? 6 : 5}.webp`,
