...
.ms-hero-glow {{ position: absolute; left: 0; right: 0; top: 0; bottom: 0; opacity: 0; transition: opacity .8s ease; mix-blend-mode: screen;
  background: radial-gradient(560px circle at var(--mx, 70%) var(--my, 50%), rgba(255, 208, 140, .14), rgba(255, 208, 140, 0) 66%); }}
.ms-parallax.is-hover .ms-hero-glow {{ opacity: 1; }}
